document.addEventListener('DOMContentLoaded', async function() {
    if (typeof ethers === 'undefined') {
        ...
        if(ledgerContainer) ledgerContainer.innerHTML = `<p style="color: #ff6b6b;">A required library (Ethers.js) failed to load.</p>`;
        return;
    }
    ...
    try {
        ...
        ledgerContainer.innerHTML = `<p style="color: #ff6b6b;">Could not load memories. The API might be busy. Please try again later.</p>`;
    }
});
