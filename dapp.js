document.addEventListener('DOMContentLoaded', function() {
    if (!document.getElementById('anchorBtn')) {
        return; 
    }
    ...
    const ledgerContractAbi = ["event MemoryAnchored(address indexed user, uint256 timestamp, string data)", "function anchor(string memory _data) public"];
