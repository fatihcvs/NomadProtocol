document.addEventListener('DOMContentLoaded', function() {
    ...
    anchorButton.addEventListener('click', async () => {
        if (typeof window.ethereum === 'undefined') { statusMessage.textContent = 'MetaMask is not installed!'; return; }
        if (!latInput.value || !lonInput.value || !msgInput.value) { statusMessage.textContent = 'Please fill in all fields.'; return; }
